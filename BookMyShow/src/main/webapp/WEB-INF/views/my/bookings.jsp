...
<body id="board-body">
                ...
                <div class="card-body">
                    <div class="row h-100 no-gutters">
                        <div class="col-md-3 h-100 d-flex align-items-center justify-content-start">
                            <a href="<c:url value='/musical/detail/${booking.musicalId}'/>" class="img-container">
                        ...
                        <div class="col-md-9 d-flex flex-column h-100 pl-3">
                            <div class="booking-info mb-2">
                                <span class="status">예매완료 ${booking.status}</span>
                                <span class="booking-date">2024-09-01 
                                ...
                                <div class="row align-items-center no-gutters mb-2">
                                    <div class="col-8 pr-2">
                                        <h5 class="card-title mb-0">
                                            <a href="<c:url value='/musical/detail/${booking.musicalId}'/>" class="card-title-link">
                                                옥탑방고양이 ${booking.musicalTitle}
                                            </a>
                                        </h5>
                                    </div>
                                    <div class="col-4 pl-2">
                                        <button class="btn btn-outline-secondary w-100"
                                            data-bs-toggle="modal" data-bs-target="#seatModal${booking.bookingId}">좌석확인</button>
                                    </div>
                                </div>
                                <div class="row align-items-center no-gutters mb-2">
                                    <div class="col-8 pr-2">
                                        <p class="card-text mb-0">공연일: 2024-12-31 
                                            <fmt:formatDate value="${booking.performanceDate}" pattern="yyyy-MM-dd" />
                                        </p>
                                    </div>
                                    <div class="col-4 pl-2">
                                        <a href="<c:url value='/my/booking-detail/${booking.bookingId}'/>" class="btn btn-outline-dark w-100">상세내역</a>
                                    </div>
                                </div>
    ...
    <!-- 좌석 확인 모달 -->
    <div class="modal fade" id="seatModal${booking.bookingId}" tabindex="-1"
        aria-labelledby="seatModalLabel${booking.bookingId}" aria-hidden="true">

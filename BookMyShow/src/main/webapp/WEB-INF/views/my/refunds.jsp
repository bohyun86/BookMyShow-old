					...
					<div class="card-body">
						<div class="row h-100 no-gutters">
							<div
								...
								<a href="<c:url value='/musical/detail/${booking.musical.musicalId}'/>"
							...
							<div class="col-md-9 d-flex flex-column h-100 pl-3">
								...
								<div
									...
									<div class="row align-items-center no-gutters mb-2">
										...
										<div class="col-4">
											<a href="<c:url value='/my/refund-detail/${booking.bookingId}'/>"
												class="btn btn-outline-dark w-100">상세내역</a>
										</div>
									</div>

                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title" >파트너 요청 승인페이지 </h2>
...
<ul class="list-group">
  <li class="list-group-item">파트너 승인 요청
  	 <div class="d-grid gap-2 d-md-flex justify-content-md-end">
  <a class="btn btn-outline-primary btn-sm" href="${pageContext.request.contextPath}/admin/partner_submit" role="submit" onclick="submitok()">승인</a> &nbsp;&nbsp;
  <form action="${pageContext.request.contextPath}/admin/partner_submit">
  		<a class="btn btn-outline-danger" type="submit" onclick="deleteok()" >삭제</a>
  </form>
  
  </li>
  <li class="list-group-item">파트너 승인 요청</li>
  <li class="list-group-item">파트너 승인 요청</li>
</ul>
